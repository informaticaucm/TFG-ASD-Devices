...
{
    uint16_t packet_length = make_cmd_reset(hci_cmd_buf);
    esp_vhci_host_send_packet(hci_cmd_buf, packet_length);
}
...
static void hci_cmd_send_set_evt_mask(void)
{
    ...
    uint16_t packet_length = make_cmd_set_evt_mask(hci_cmd_buf, evt_mask);
    esp_vhci_host_send_packet(hci_cmd_buf, packet_length);
}
...
static void hci_cmd_send_ble_scan_params(void)
{
    ...
    uint16_t packet_length = make_cmd_ble_set_scan_params(hci_cmd_buf, scan_type, scan_interval, scan_window, own_addr_type, filter_policy);
    esp_vhci_host_send_packet(hci_cmd_buf, packet_length);
}
...
static void hci_cmd_send_ble_scan_start(void)
{
    ...
    uint16_t packet_length = make_cmd_ble_set_scan_enable(hci_cmd_buf, scan_enable, filter_duplicates);
    esp_vhci_host_send_packet(hci_cmd_buf, packet_length);
...
{
    uint16_t packet_length = make_cmd_ble_set_adv_enable(hci_cmd_buf, 1);
    esp_vhci_host_send_packet(hci_cmd_buf, packet_length);
...
static void hci_cmd_send_ble_set_adv_param(void)
{
    ...
    uint16_t packet_length = make_cmd_ble_set_adv_param(hci_cmd_buf,
                                             adv_intv_min,
                                             adv_intv_max,
                                             adv_type,
                                             own_addr_type,
...
static void hci_cmd_send_ble_set_adv_data(void)
{
    ...
    uint16_t packet_length = make_cmd_ble_set_adv_data(hci_cmd_buf, adv_data_len, (uint8_t *)adv_data);
    esp_vhci_host_send_packet(hci_cmd_buf, packet_length);
